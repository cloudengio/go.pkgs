...
// KeyInfoFromContext retrieves the KeyInfo for the specified user and ID from the context.
...
// TokenFromContextForID retrieves the Token for the specified user and ID from the context.
