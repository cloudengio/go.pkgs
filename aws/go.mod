...
require (
	...
	cloudeng.io/webapp v0.0.0-20240120234157-7e30acc5437f
...
require (
	cloudeng.io/cmdutil v0.0.0-20240120234157-7e30acc5437f // indirect
	...
	github.com/orlangure/gnomock v0.30.0 // indirect
