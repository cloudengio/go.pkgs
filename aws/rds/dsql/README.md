...
the context to create a DSQL client. This is a convenient wrapper
around Cluster.GetPrivateLinkServiceName. clusterID may be either
a bare 26-character cluster ID or a full endpoint hostname (e.g.
