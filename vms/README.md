...
it if necessary. Running VMs are stopped before deletion. It returns an
error if the instance is not Stopped or Deleted after the cleanup or if the
cleanup fails for any other reason.
